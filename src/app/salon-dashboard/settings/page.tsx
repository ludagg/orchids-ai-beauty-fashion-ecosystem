          ...
          {activeTab === "Profile" && (
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row items-center gap-8">
                  ...
                  <div className="space-y-2 text-center sm:text-left">
                    ...
                    <div className="flex gap-2 mt-4 justify-center sm:justify-start">
                      <button className="px-5 py-2.5 rounded-xl bg-muted text-foreground text-xs font-bold hover:bg-muted/80 transition-all border border-border">Replace</button>
                      <button className="px-5 py-2.5 rounded-xl text-rose-500 text-xs font-bold hover:bg-rose-500/10 transition-all">Remove</button>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex justify-end gap-4">
                ...
                <button className="px-8 py-4 rounded-2xl bg-foreground text-white text-sm font-bold hover:opacity-90 shadow-xl shadow-foreground/10 transition-all">Save Changes</button>
              </div>
            </motion.div>
          )}
