...
export default function SidebarLayoutClient({
  ...
  const boutiqueItems = [
    { icon: LayoutDashboard, label: "Dashboard", href: "/salon-dashboard" },
    { icon: Package, label: "Orders", href: "/salon-dashboard/orders" },
    { icon: ShoppingBag, label: "Products", href: "/salon-dashboard/products" },
    { icon: Users, label: "Customers", href: "/salon-dashboard/customers" },
    { icon: IndianRupee, label: "Earnings", href: "/salon-dashboard/earnings" },
    { icon: Settings, label: "Settings", href: "/salon-dashboard/settings" },
  ];

  const navItems = salon?.type === 'BOUTIQUE' ? boutiqueItems : salonItems;

  const salonName = salon?.name || "My Business";
  const roleName = salon?.type === 'BOUTIQUE' ? "Store Manager" : "Salon Manager";
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="min-w-0">
              <p className="text-sm font-bold truncate">{salonName}</p>
