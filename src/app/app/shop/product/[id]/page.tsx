  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="p-4 space-y-6">
        ...
        {/* AI Fit Check */}
        <AIFitCheckDialog product={product} onSizeRecommended={(size) => {
            if (product.sizes?.some((s: any) => s.name === size)) {
                setSelectedSize(product.sizes.find((s: any) => s.name === size));
                toast.success(`Selected recommended size: ${size}`);
            }
        }} />
