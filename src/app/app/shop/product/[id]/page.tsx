  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="p-4 space-y-6">
        ...
        {/* AI Fit Check */}
        <AIFitCheck product={product} userMeasurements={session?.user ? { height: (session.user as any).height, weight: (session.user as any).weight, bodyType: (session.user as any).bodyType } : undefined} />
