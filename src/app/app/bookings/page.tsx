        ...
        {activeTab === "Bookings" ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {bookings.map((booking, i) => (
              ...
              >
                <Link href={`/app/bookings/${booking.id}`} className="flex-1">
              ...
              >
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-4">
                    ...
                    <Link href={`/app/bookings/${order.id}`} className="px-8 py-4 rounded-2xl border border-border text-foreground font-bold text-sm hover:bg-muted transition-all flex items-center justify-center">
                      Order Details
                    </Link>
