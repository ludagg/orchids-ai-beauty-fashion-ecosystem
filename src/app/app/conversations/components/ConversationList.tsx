...
export default function ConversationList({ selectedId, className = "" }: ConversationListProps) {
  return (
    <aside className={`w-full lg:w-96 border-r border-border flex flex-col bg-card ${className}`}>
