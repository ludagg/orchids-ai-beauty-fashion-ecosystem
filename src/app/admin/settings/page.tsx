  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500 mt-1">Configure platform-wide parameters and infrastructure settings.</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <main className="flex-1 space-y-8 pb-20">
          {activeTab === "System" && (
            ...
            >
              {/* API Configuration */}
              <section className="p-8 bg-white border border-slate-200 rounded-[32px] space-y-8 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest px-1">Environment</label>
                    <select className="w-full px-5 py-3.5 rounded-xl bg-slate-50 border-transparent focus:bg-white focus:border-slate-200 outline-none text-sm font-bold text-slate-900 transition-all">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest px-1">AI Engine Region</label>
                    <select className="w-full px-5 py-3.5 rounded-xl bg-slate-50 border-transparent focus:bg-white focus:border-slate-200 outline-none text-sm font-bold text-slate-900 transition-all">
                  ...
                  <div className="md:col-span-2 space-y-2">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest px-1">Global API Key</label>
                    <div className="relative">
                      <input type="password" readOnly value="********************************" className="w-full px-5 py-3.5 rounded-xl bg-slate-50 border-transparent outline-none text-sm font-medium transition-all" />
              ...
              {/* Security Policy */}
              <section className="p-8 bg-white border border-slate-200 rounded-[32px] space-y-6 shadow-sm">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.label} className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
                      ...
                      <button className={`w-12 h-6 rounded-full relative transition-colors ${item.active ? 'bg-indigo-600' : 'bg-slate-200'}`}>
              ...
              <div className="flex justify-end gap-4">
                <button className="px-8 py-4 rounded-xl text-sm font-bold text-slate-500 hover:bg-slate-50 transition-all">Reset to Defaults</button>
          ...
          {activeTab !== "System" && (
            <div className="py-20 flex flex-col items-center justify-center text-center space-y-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-slate-900">{activeTab} Configuration</h2>
                <p className="text-slate-500 mt-1 max-w-xs">Settings for {activeTab} are currently being migrated to the new core.</p>
              </div>
            </div>
          )}
        </main>
