        ...
        <div className="w-full max-w-[440px] px-6 relative z-10">
          ...
          >
            <div className="text-center mb-8">
              <h1 className="text-3xl font-semibold font-display mb-2">Create Account</h1>
              <p className="text-[#6b6b6b] text-sm">
                Join Priisme today and experience the future of fashion
              </p>
            </div>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6b6b6b] transition-colors group-focus-within:text-[#1a1a1a]" />
                  <input
                    type="text"
