    ...
    <div className="min-h-screen bg-[#fafafa] flex flex-col items-center justify-center p-6 selection:bg-black/10">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] bg-violet-500/[0.05] blur-[100px] rounded-full"
        />
        <motion.div
          animate={{ x: [0, -30, 0], y: [0, -50, 0] }}
          transition={{ duration: 20, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-[20%] -right-[10%] w-[35%] h-[35%] bg-emerald-500/[0.05] blur-[100px] rounded-full"
        />
      </div>
      ...
      >
        ...
        <div className="bg-white rounded-[32px] p-8 md:p-10 shadow-xl shadow-black/5 border border-[#e5e5e5]">
          <div className="mb-10">
            ...
            <p className="text-[#6b6b6b]">Créez votre compte pour rejoindre l'écosystème Priisme.</p>
          </div>
