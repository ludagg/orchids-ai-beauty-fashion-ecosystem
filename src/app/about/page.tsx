  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-32 pb-16 px-6 max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold font-display mb-6">About Rare</h1>
        <div className="prose dark:prose-invert max-w-none space-y-4 text-muted-foreground">
          ...
          <p>
            Rare is an AI-powered ecosystem that connects fashion enthusiasts with designers, salons, and stylists. Our mission is to personalize style and beauty services for everyone using cutting-edge technology.
          </p>
          <p>
