      ...
      <div className="space-y-4">
        {apptList.map((app, i) => (
          ...
          >
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`px-2 py-0.5 rounded-full text-[8px] font-bold uppercase tracking-widest ${
                    app.status === 'Confirmed' ? 'bg-emerald-500/10 text-emerald-600' :
            ...
            <div className="flex items-center justify-between md:justify-end gap-8 border-t border-border md:border-t-0 pt-4 md:pt-0">
                ...
                {app.status === 'Pending' && (
                  <>
                    <button
                      ...
                      className="p-2.5 rounded-xl bg-emerald-500/10 text-emerald-600 hover:bg-emerald-500/20 transition-all"
                      title="Accept"
                    >
                    ...
                    <button
                      ...
                      className="p-2.5 rounded-xl bg-rose-500/10 text-rose-600 hover:bg-rose-500/20 transition-all"
                      title="Cancel"
                    >
                      <X className="w-5 h-5" />
                    </button>
