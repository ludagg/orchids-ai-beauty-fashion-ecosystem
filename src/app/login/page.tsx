      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-[#1a1a1a]">
        ...
        <div className="relative z-10 w-full flex flex-col justify-between p-12 text-white">
          ...
          <div className="max-w-md">
            ...
            >
              L'élégance redéfinie par <span className="italic text-rose-400">l'intelligence.</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Rejoignez la première plateforme de mode augmentée par IA en Inde.
              Découvrez des styles uniques et des services de beauté vérifiés.
            </motion.p>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-12 md:px-12 lg:px-24 relative bg-[#fafafa]">
        ...
        >
          ...
          <div className="mb-10">
            ...
            <p className="text-[#6b6b6b]">Accédez à votre espace personnalisé.</p>
          </div>
