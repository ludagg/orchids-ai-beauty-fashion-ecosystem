...
export function ProductCard({ product, view = 'grid' }: ProductCardProps) {
  ...
  return (
    <div className={cn(
      ...
      {/* Wishlist Button - Absolute Positioned and Interactive */}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              variant="ghost"
              className={cn(
                  "h-8 w-8 rounded-full backdrop-blur-sm transition-all pointer-events-auto",
                  isWishlisted
      ...
      {/* Content */}
      <div className="flex flex-1 flex-col p-4 pointer-events-none relative z-10">
