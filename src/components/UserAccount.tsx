      ...
      <DropdownMenuContent className="w-auto p-2" align="end" sideOffset={8}>
        <div className="grid grid-cols-4 gap-2 min-w-[340px]">
          <DropdownMenuItem asChild className="focus:bg-transparent p-0">
            <Link
              href="/app/profile"
              className="flex flex-col items-center justify-center gap-1.5 p-3 rounded-lg hover:bg-accent focus:bg-accent transition-colors text-center w-full h-20 group"
            >
