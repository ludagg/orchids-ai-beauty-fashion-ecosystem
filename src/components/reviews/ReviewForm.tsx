        ...
        <form onSubmit={handleSubmit} className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-4 gap-2">
              {previews.map((src, i) => (
                <div key={i} className="relative aspect-square rounded-lg overflow-hidden border border-border group focus-within:ring-2 focus-within:ring-ring">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        ...
                        className="absolute top-1 right-1 p-1 rounded-full bg-black/50 text-white opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity outline-none"
