...
/* [Jules - Enhance accessibility and UX with ARIA labels, Tooltips, and semantic roles] */
    ...
    >
        ...
        <Tooltip>
            <TooltipTrigger asChild>
                <button onClick={onClose} className="absolute top-4 right-4 z-50 text-white p-2 hover:bg-white/10 rounded-full hidden md:block" aria-label="Close story viewer">
                    <X className="w-8 h-8" aria-hidden="true" />
                </button>
            </TooltipTrigger>
            <TooltipContent side="left"><p>Close (Esc)</p></TooltipContent>
        </Tooltip>
        ...
        <Tooltip>
            ...
            <TooltipContent side="right"><p>Previous (←)</p></TooltipContent>
        </Tooltip>
         ...
         <Tooltip>
            ...
            <TooltipContent side="left"><p>Next (→)</p></TooltipContent>
        </Tooltip>
      ...
      <div className="relative w-full h-full md:w-[400px] md:h-[80vh] md:rounded-2xl overflow-hidden bg-gray-900 shadow-2xl">
        ...
        {/* Progress Bars */}
        <div className="absolute top-0 left-0 right-0 z-20 flex gap-1 p-2" role="group" aria-label="Story progress">
