        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className="absolute top-4 right-4 z-50 text-white p-2 hover:bg-white/10 rounded-full hidden md:block outline-none focus-visible:ring-2 focus-visible:ring-white"
            >
              <X className="w-8 h-8" />
            </button>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
                ...
                aria-label="Previous story (Left arrow)"
                className="hidden md:flex absolute left-4 top-1/2 -translate-y-1/2 text-white/50 hover:text-white z-50 p-2 outline-none focus-visible:ring-2 focus-visible:ring-white rounded-full transition-colors disabled:opacity-20"
         ...
         <Tooltip>
           <TooltipTrigger asChild>
            <button
                ...
                aria-label="Next story (Right arrow)"
                className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 text-white/50 hover:text-white z-50 p-2 outline-none focus-visible:ring-2 focus-visible:ring-white rounded-full transition-colors"
            >
      ...
      <div className="relative w-full h-full md:w-[400px] md:h-[80vh] md:rounded-2xl overflow-hidden bg-gray-900 shadow-2xl">
        ...
        <div className="absolute top-4 left-0 right-0 z-20 flex items-center justify-between px-4 pt-2">
            ...
            <button
                ...
                className="md:hidden text-white drop-shadow-md p-1 active:scale-95 transition-transform"
            >
                <X className="w-6 h-6" />
            </button>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 z-20 p-4 bg-gradient-to-t from-black/60 to-transparent flex items-center gap-4">
             <div className="flex-1 relative">
                 <input
                    ...
                    aria-label="Send a message to the creator"
             ...
             <Tooltip>
               <TooltipTrigger asChild>
                 <button
                    className="text-white hover:scale-110 transition-transform p-1 outline-none focus-visible:ring-2 focus-visible:ring-white rounded-full"
