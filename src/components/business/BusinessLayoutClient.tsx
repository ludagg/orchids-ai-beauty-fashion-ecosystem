...
export default function BusinessLayoutClient({
  ...
  const NavLink = ({ href, icon: Icon, label, className = "", ariaLabel, iconClassName = "" }: { href: string, icon: any, label: string, className?: string, ariaLabel?: string, iconClassName?: string }) => {
