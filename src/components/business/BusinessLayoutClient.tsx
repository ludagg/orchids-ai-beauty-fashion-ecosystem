        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto no-scrollbar">
           {(() => {
              const backToAppLink = (
                <Link
                  href="/app"
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all text-muted-foreground hover:bg-secondary hover:text-foreground mb-4 border-b border-border pb-4 outline-none focus-visible:ring-2 focus-visible:ring-primary ${isCollapsed ? "justify-center" : ""}`}
