          ...
          {isCollapsed ? (
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  href="/app"
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all text-muted-foreground hover:bg-secondary hover:text-foreground mb-4 border-b border-border pb-4 justify-center"
      ...
      <header className="lg:hidden bg-card/80 backdrop-blur-md sticky top-0 z-40 border-b border-border">
        <div className="h-16 px-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <button onClick={() => setMobileMenuOpen(true)} className="p-2 ml-1" aria-label="Open menu">
